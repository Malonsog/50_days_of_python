...
list_of_figures = [1000000, 2356989, 2354672, 9878098]


def convert_numbers(list_of_numbers):
    formatted_list = [f"{number:,}" for number in list_of_numbers]
    return formatted_list


print(convert_numbers(list_of_figures))
